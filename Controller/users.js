...
exports.userLogin = async (req, res) => {
    try {
        ...
        res.status(200).header('set-cookie', `jwt_token=${token}; Path=/; Expires=1000*60*60*1;SameSite=None; secure;httpOnly`).send({ jwt: token, message: "You have been Logged in Successfully", username: emailFound.username, isAuthenticated: true });
